========================
PyLit6 - Project History
========================

..  include::   docs/references.inc

The PyLit_ project began as a personal research project when Dr. Knuth's first
papers on |LP| were published in 1984. I was then, and remain today, convinced
that |LP| had a real place in the academic world, even if it did take off as a
mainstream development technique. At the time, I was serving in the USAF, and
was assigned as a computer science instructor at the `Air Force Institute of
Technology <www.afit.edu>`_, the USAF's graduate school. I was working to find
a way to understand why students wrote their lab projects the way they did,
when all I had to go by was a final printed program listing. It struck me that
having students use |LP| to explain their code would be extremely useful. They
would have to think more and code less, and their writings would help me
identify deficiencies in their thinking, and ultimately help build better
software engineers.
...
Today, PyLit_ is still a web application, but has now been re-engineered using
